...
export const modules: Module[] = [
  ...
  { id: 5,  name: 'European Power Sector',        tier: 'foundation', description: 'Breaking problems into logical parts and clear flows.' },
  { id: 6,  name: 'Environment & Sustainability', tier: 'foundation', description: 'Prioritising tasks and managing energy for consistent delivery.' },
